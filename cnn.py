...
model = tflearn.DNN(network, tensorboard_verbose=0, checkpoint_path='./cnn/bird-classifier.tfl.ckpt')

# Train it! We'll do 100 training passes and monitor it as it goes.
model.fit(X, Y, n_epoch=100, shuffle=True, validation_set=(X, Y),
